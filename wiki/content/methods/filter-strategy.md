...
5. **Exclusion direction is asymmetric.** High-cost comps exclude low-cost reroll carries (Nasus 3★ i3 in nova_95 = Bonk contamination; hero augment carries fall into the same category). Low-cost reroll comps do NOT exclude high-cost carries (Fiora in Bonk = the player's cap board, a legitimate part of the comp's games).
